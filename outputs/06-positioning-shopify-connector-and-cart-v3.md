...
| **U6** | **Payment processing built for DSOs, with no platform subscription on top** | Shopify charges a platform subscription **on top of** processing — $29 to $2,300–2,500/mo, plus a 0.35–0.40% variable fee on total GMV above ~$800K/mo on Plus, plus a 0.2–2.0% surcharge if you don't use Shopify Payments. We charge no separate platform subscription. Shopify Payments is also unfriendly to MLM/DSO risk profiles. | ✅ **Subscription half verified 2026-09-11.** 🛑 **"Materially below Shopify's rate" was REMOVED — it is contradicted by the evidence.** See below and `02-competitor-analysis-shopify-payment-rates.md`. |
...
1. **U6 — PARTLY CLOSED 2026-09-11, and the verification reversed half the claim.** Rate cards for both sides were obtained (Wayroo sell sheet + Shopify Payments in-app card) and worked through in `02-competitor-analysis-shopify-payment-rates.md`.
   - ✅ **Closed — the "no second subscription" half is verified and stronger than it looked.** Shopify's real cost is a stack: $29–$2,500/mo subscription + 0.35–0.40% of total GMV above ~$800K/mo on Plus + a 0.2–2.0% non-Shopify-Payments gateway surcharge, *then* the card rate. That is where the 7-figure argument lives and every line of it is verified.
   - 🛑 **Reversed — "materially below Shopify's rate" is false and has been cut from U6.** Wayroo's published card rate is **2.85% + $0.00 CP / 3.5% + $0.15 CNP**. Shopify Payments runs **2.15–2.9% + 30¢** online and **2.4–2.6% + 10¢** in person. Above roughly **$25 CNP / $40 CP**, Shopify is cheaper on the rate line. The `~3% → ~1%` line in `12-battlecard-shopify.md`, `12-one-pager.md` and `12-sales-deck.md` compares Shopify's *retail card rate* against our *Spendback wholesale* rate — two different transaction types. **A CFO will catch this.**
   - ✅ **New and usable:** we charge **no fixed per-transaction cent card-present**, so we beat Shopify *and* Square on small tickets — $0.14 vs $0.23 vs $0.28 on a $5 sale, break-even at $40 (Shopify Basic) and $60 (Square). This is the Cash & Carry segment's own economics, so it reinforces that positioning.
   - ⚠️ **STILL OPEN (R1) — the number this motion actually needs.** Everything above is **Wayroo/ProPay**. This motion sells the **Freedom cart**, whose Nuvei-through-us merchant rate is still unobtained. **U6 does not ship in any form until R1 closes.** Sam Atieh, 2026-09-25.
   - ⚠️ **Still open (R2):** no per-client all-in Shopify cost. One real client invoice turns the §3 stack into a closing tool. Sam / Finance, 2026-10-02.
...
| **U6** DSO-fit payments, no second subscription | **You stop paying twice.** With Shopify the processing rate is the *smallest* line: you also pay a platform subscription (up to $2,300–2,500/mo), a 0.35–0.40% variable fee on **total** GMV above ~$800K/mo on Plus, and a 0.2–2.0% surcharge if you bring your own gateway. A Plus merchant at $10M/yr GMV pays ~$30–40K/yr in platform fees before processing a single card. We charge none of that — and the processor doesn't treat your industry as a risk category. 🛑 **Argue the stack, never a blended rate:** our card rate is *not* below Shopify's above small tickets. See `02-competitor-analysis-shopify-payment-rates.md`. |
